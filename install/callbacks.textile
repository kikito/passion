...
This however should be the exception, not the rule; normally you should be using subclasses of "passion.Actor":{{ site.root_path }}/passion.Actor/intro , which will be automatically updated by passion.update.
