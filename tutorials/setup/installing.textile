...
If you can't use git, you can download this project in either "zip":{{ site.urls.github }}/zipball/master or "tar":{{ site.urls.github }}/tarball/master formats:

p=. "!http://github.com/images/modules/download/zip.png(zip)!":{{ site.urls.github }}/zipball/master "!http://github.com/images/modules/download/tar.png(tar)!":{{ site.urls.github }}/tarball/master
